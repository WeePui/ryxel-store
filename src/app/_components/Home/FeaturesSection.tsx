...
export default function FeaturesSection() {
  return (
    <section className="flex max-w-7xl mx-auto px-4 py-20 lg:py-12 gap-24 md:gap-10 md:flex-col">
      ...
      <div className="flex-[7] grid grid-cols-3 md:grid-cols-2 gap-12 md:gap-4 lg:justify-items-center">
