...
export default function MobileMenuTranslated() {
  ...
  return (
    <>
      ...
      {menuOpen && (
        <div className="fixed top-0 z-40 h-full w-full animate-slide-in bg-white p-6 shadow-lg lg:right-0 lg:w-7/12 lg:animate-slide-in-reverse md:left-0 md:w-full md:animate-slide-in">
          <button
